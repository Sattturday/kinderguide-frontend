...
const createCache = (t2, n2) => {
  ...
  return [
    n2 ? (t3) => cacheUpdateContextual(n2(c2, r2), t3) : cacheUpdateContextual,
    (t3) => [c2, !!t3, r2],
  ];
};
...
const { round: p } = Math;
const b = { w: 0, h: 0 };
const offsetSize = (t2) => (t2 ? { w: t2.offsetWidth, h: t2.offsetHeight } : b);
const clientSize = (t2) => (t2 ? { w: t2.clientWidth, h: t2.clientHeight } : b);
const scrollSize = (t2) => (t2 ? { w: t2.scrollWidth, h: t2.scrollHeight } : b);
...
const createStructureSetupElements = (t2) => {
  ...
  const elementIsGenerated = (t3) => (t3 ? indexOf(tt2, t3) > -1 : null);
  ...
  let at2 = b3
    ? nt2
    : contents(
        [ct2, et2, st2, ot2, nt2].find((t3) => elementIsGenerated(t3) === !1)
      );
  ...
  return [
    ...
    () => {
      ...
      if (
        ...
        rt2 && (insertBefore(et2, rt2), push(it2, removeElements.bind(0, rt2))),
        K2)
      ) {
...
const jt = { u: equalXY, o: { x: Bt, y: Bt } };
...
const createOverflowUpdateSegment = (t2, n2) => {
  ...
  const [H2, P2] = g2
    ? g2.H(w3, _2, r2, i2, o2, getViewportOverflowState, hideNativeScrollbars)
    : [() => w3, () => [noop]];
  return (t3, n3, i3) => {
    ...
    if (
      ...
      const _3 = { w: Rt(Mt(e3.w, u4.w) + o3.w), h: Rt(Mt(e3.h, u4.h) + o3.h) };
      const h3 = {
    ...
    if (w4 || Y2 || dt2 || at2 || ct2 || it2 || X2 || F3 || W2) {
      ...
      const n4 = setViewportOverflowState(U2, ft2, G2, t4);
...
const createDOMObserver = (t2, n2, o2, s2) => {
  ...
  const [_2, h2] = createEventContentChange(t2, f3, i2);
  const v3 = c2 || [];
  const g2 = r2 || [];
  const w3 = v3.concat(g2);
...
const createSizeObserver = (t2, n2, o2) => {
  ...
  const c2 = getPlugins()[xt];
  const { B: r2 } = getEnvironment();
  const l2 = createDOM(`<div class="${j}"><div class="${q}"></div></div>`)[0];
  ...
  const _2 = [];
  let h2 = e2 ? onSizeChangedCallbackProxy : !1;
  return [
    () => {
    ...
    [
      ...
      (t3) => {
        ...
        if (
          ...
          } else isNumber(f4) ? ((s2 = f4), (e2 = !1)) : ((s2 = !1), (e2 = !1));
      },
    ]
  );
};
const Wt = { x: 0, y: 0 };
const createInitialStructureSetupUpdateState = (t2) => ({
  K: { t: 0, r: 0, b: 0, l: 0 },
  St: !1,
  P: {
    marginRight: 0,
...
const createStructureSetup = (t2, n2) => {
  ...
  const [u2, d2] = a2;
  const f3 = createStructureSetupUpdate(r2, a2);
  const triggerUpdateEvent = (t3, n3, o3) => {
    const e3 = keys(t3).some((n4) => t3[n4]) || !isEmptyObject(n3) || o3;
...
const createInteractiveScrollEvents = (t2, n2, o2, s2, e2, c2, r2) => {
  ...
  const createRelativeHandleMove = (t3, n3) => (o3) => {
    ...
    const p2 = directionIsRTL(u2) && r2 ? (i2.n || i2.i ? 1 : -1) : 1;
    e2[d2] = t3 + h3 * p2;
  };
  return on(a2, 'pointerdown', (s3) => {
    ...
    if ((attrClass(n2, T, H, !0), continuePointerDown(s3, t2, c3))) {
      ...
      const i3 = createRelativeHandleMove(e2[d2] || 0, 1 / getScale(e2)[g2]);
      const u3 = s3[f3];
...
const createScrollbarsSetupElements = (t2, n2, o2) => {
  ...
  const { slot: r2 } = c2;
  const { ct: i2, W: l2, Z: a2, J: u2, lt: d2, ot: f3, it: h2, ut: v3 } = n2;
  ...
  const scrollbarStructureRefreshHandleOffset = (t3, n3, o3) => {
    ...
    scrollbarsHandleStyle(t3, (t4) => {
      ...
      const i3 = getScrollbarHandleOffsetRatio(
        e3,
        c3,
        f3,
        n3,
    ...
    [
      (t3, s3, i3) => {
        ...
        const setScrollbarVisibility = (t4, n3) => {
          const o3 = $3 === 'visible' || ($3 === 'auto' && t4 === 'scroll');
...
const OverlayScrollbars = (t2, n2, o2) => {
  ...
  if (n2 && !u2) {
    ...
    let $2 = {
      ...
      state() {
        const { zt: t3, Tt: n3, Ct: o3, Et: s3, K: e3, St: c3, bt: r3 } = g2();
        return assignDeep(
          {},
          {
            overflowEdge: t3,
      ...
      elements() {
        const { W: t3, Z: n3, K: o3, J: s3, tt: e3, ot: c3, st: r3 } = g2.qt;
...
const S2 = (l2) => {
  ...
  const [a2, i2] = (0, import_react.useMemo)(O2, []);
  const r2 = (0, import_react.useRef)(null);
  const u2 = (0, import_react.useRef)(o2);
  const s2 = (0, import_react.useRef)(c2);
  const n2 = (0, import_react.useRef)(t2);
  return (
    ...
    (0, import_react.useMemo)(
      () => [
        (e2) => {
          ...
          const I2 = s2.current || {};
          const m2 = n2.current || {};
          const p2 = () => (r2.current = OverlayScrollbars(e2, I2, m2));
          d2 ? a2(p2, d2) : p2();
        },
        () => r2.current,
      ],
...
const F2 = (l2, c2) => {
  ...
  const s2 = t2;
  const n2 = (0, import_react.useRef)(null);
  const e2 = (0, import_react.useRef)(null);
  const [y2, d2] = S2({ options: o2, events: a2, defer: i2 });
  return (
    (0, import_react.useEffect)(() => {
      const { current: I2 } = n2;
      const { current: m2 } = e2;
      return (
        I2 && m2 && y2({ target: I2, elements: { viewport: m2, content: m2 } }),
        () => {
          let p2;
...
const A2 = (0, import_react.forwardRef)(F2);
const OverlayScrollbars2 = A2;
const OverlayScrollbars_default = A2;
export {
