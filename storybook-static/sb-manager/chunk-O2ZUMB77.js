...
const require_markdown = __commonJS({
  '../../node_modules/refractor/lang/markdown.js': function (exports, module) {
    ...
    function markdown(Prism) {
      (function (Prism2) {
        ...
        (Prism2.languages.markdown = Prism2.languages.extend('markup', {})),
          ...
          Prism2.hooks.add('wrap', (env) => {
            if (env.type === 'code-block') {
              ...
              const grammar = Prism2.languages[codeLang];
              if (grammar)
                ...
                (env.attributes.id = id),
                  Prism2.plugins.autoloader.loadLanguages(codeLang, () => {
        ...
        const KNOWN_ENTITY_NAMES = { amp: '&', lt: '<', gt: '>', quot: '"' };
...
const require_yaml = __commonJS({
  '../../node_modules/refractor/lang/yaml.js': function (exports, module) {
    (module.exports = yaml),
...
const require_typescript = __commonJS({
  '../../node_modules/refractor/lang/typescript.js': function (
    ...
    function typescript(Prism) {
      (function (Prism2) {
        ...
        const typeInside = Prism2.languages.extend('typescript', {});
...
const require_jsx = __commonJS({
  '../../node_modules/refractor/lang/jsx.js': function (exports, module) {
...
const require_tsx = __commonJS({
  '../../node_modules/refractor/lang/tsx.js': function (exports, module) {
    const refractorJsx = require_jsx();
    const refractorTypescript = require_typescript();
    ...
    function tsx(Prism) {
      Prism.register(refractorJsx),
        ...
        (function (Prism2) {
          ...
          const { tag } = Prism2.languages.tsx;
          (tag.pattern = RegExp(
...
const require_clike = __commonJS({
  '../../node_modules/refractor/lang/clike.js': function (exports, module) {
...
const require_javascript = __commonJS({
...
const require_css = __commonJS({
  '../../node_modules/refractor/lang/css.js': function (exports, module) {
...
const require_markup = __commonJS({
  '../../node_modules/refractor/lang/markup.js': function (exports, module) {
...
const require_immutable = __commonJS({
  '../../node_modules/xtend/immutable.js': function (exports, module) {
...
const require_schema = __commonJS({
...
const require_merge = __commonJS({
  '../../node_modules/property-information/lib/util/merge.js': function (
    ...
    const xtend = require_immutable();
    const Schema = require_schema();
    module.exports = merge;
    function merge(definitions) {
      for (
        var { length } = definitions,
          property = [],
          normal = [],
          index = -1,
          info,
...
const require_normalize = __commonJS({
...
const require_create = __commonJS({
  '../../node_modules/property-information/lib/util/create.js': function (
    ...
    const Schema = require_schema();
    const DefinedInfo = require_defined_info();
...
const require_xlink = __commonJS({
  '../../node_modules/property-information/lib/xlink.js': function (
    exports,
    module
  ) {
    const create = require_create();
    module.exports = create({
      space: 'xlink',
...
const require_case_sensitive_transform = __commonJS({
...
const require_case_insensitive_transform = __commonJS({
  '../../node_modules/property-information/lib/util/case-insensitive-transform.js':
    function (exports, module) {
      const caseSensitiveTransform = require_case_sensitive_transform();
...
const require_xmlns = __commonJS({
  '../../node_modules/property-information/lib/xmlns.js': function (
    exports,
    module
  ) {
    const create = require_create();
    const caseInsensitiveTransform = require_case_insensitive_transform();
    module.exports = create({
      space: 'xmlns',
...
const require_html2 = __commonJS({
  '../../node_modules/property-information/html.js': function (
    exports,
    module
  ) {
    const merge = require_merge();
    const xlink = require_xlink();
    const xml = require_xml();
    const xmlns = require_xmlns();
    const aria = require_aria();
    const html = require_html();
    module.exports = merge([xml, xlink, xmlns, aria, html]);
  },
});
const require_find = __commonJS({
...
const require_hast_util_parse_selector = __commonJS({
...
const require_space_separated_tokens = __commonJS({
  '../../node_modules/space-separated-tokens/index.js': function (exports) {
...
const require_comma_separated_tokens = __commonJS({
  '../../node_modules/comma-separated-tokens/index.js': function (exports) {
    (exports.parse = parse), (exports.stringify = stringify);
    const comma = ',';
    const space = ' ';
    const empty = '';
    ...
    function stringify(values, options) {
      ...
      const left = settings.padLeft === !1 ? empty : space;
...
const require_factory = __commonJS({
  '../../node_modules/hastscript/factory.js': function (exports, module) {
    const find = require_find();
    const normalize = require_normalize();
    const parseSelector = require_hast_util_parse_selector();
    const spaces = require_space_separated_tokens().parse;
    const commas = require_comma_separated_tokens().parse;
    module.exports = factory;
    const own = {}.hasOwnProperty;
    function factory(schema, defaultTagName, caseSensitive) {
      const adjust = caseSensitive ? createAdjustMap(caseSensitive) : null;
      return h;
    ...
    function createAdjustMap(values) {
      for (
        var { length } = values, index = -1, result = {}, value;
        ++index < length;
...
const require_html3 = __commonJS({
  '../../node_modules/hastscript/html.js': function (exports, module) {
    const schema = require_html2();
    const factory = require_factory();
    const html = factory(schema, 'div');
    (html.displayName = 'html'), (module.exports = html);
  },
});
const require_hastscript = __commonJS({
  '../../node_modules/hastscript/index.js': function (exports, module) {
    module.exports = require_html3();
  },
});
const require_character_entities_legacy = __commonJS({
...
const require_character_reference_invalid = __commonJS({
  '../../node_modules/character-reference-invalid/index.json': function (
    exports,
    module
  ) {
    module.exports = {
...
const require_is_decimal = __commonJS({
  '../../node_modules/is-decimal/index.js': function (exports, module) {
...
const require_is_hexadecimal = __commonJS({
  '../../node_modules/is-hexadecimal/index.js': function (exports, module) {
...
const require_is_alphabetical = __commonJS({
  '../../node_modules/is-alphabetical/index.js': function (exports, module) {
...
const require_is_alphanumerical = __commonJS({
  '../../node_modules/is-alphanumerical/index.js': function (exports, module) {
    const alphabetical = require_is_alphabetical();
    const decimal = require_is_decimal();
...
const require_character_entities = __commonJS({
...
const require_decode_entity = __commonJS({
  '../../node_modules/parse-entities/decode-entity.js': function (
    exports,
    module
  ) {
    const characterEntities = require_character_entities();
...
const require_parse_entities = __commonJS({
  '../../node_modules/parse-entities/index.js': function (exports, module) {
    const legacy = require_character_entities_legacy();
    const invalid = require_character_reference_invalid();
    const decimal = require_is_decimal();
    const hexadecimal = require_is_hexadecimal();
    const alphanumerical = require_is_alphanumerical();
    const decodeEntity = require_decode_entity();
    ...
    const namedNotTerminated = 1;
    const numericNotTerminated = 2;
    const namedEmpty = 3;
    const numericEmpty = 4;
    const namedUnknown = 5;
    const numericDisallowed = 6;
    const numericProhibited = 7;
    const messages = {};
...
const require_prism_core = __commonJS({
      ...
      const Prism = (function (_self2) {
        ...
        var _ = {
          ...
          languages: {
            ...
            extend(id, redef) {
              const lang2 = _.util.clone(_.languages[id]);
              for (const key in redef) lang2[key] = redef[key];
              return lang2;
            },
...
const require_core = __commonJS({
  '../../node_modules/refractor/core.js': function (exports, module) {
    const ctx =
    ...
    const h = require_hastscript();
    const decode = require_parse_entities();
    const Prism = require_prism_core();
    const markup = require_markup();
    const css = require_css();
    const clike = require_clike();
    const js = require_javascript();
    restore();
    const own = {}.hasOwnProperty;
    function Refractor() {}
    ...
    function stringifyAll(values, language) {
      for (
        var result = [], { length } = values, index = -1, value;
        ++index < length;
...
const require_bash = __commonJS({
  '../../node_modules/refractor/lang/bash.js': function (exports, module) {
    (module.exports = bash),
...
const require_js_extras = __commonJS({
  '../../node_modules/refractor/lang/js-extras.js': function (exports, module) {
    ...
    function jsExtras(Prism) {
      (function (Prism2) {
        ...
        for (
          ...
          let value = Prism2.languages.javascript[token];
...
const require_json = __commonJS({
  '../../node_modules/refractor/lang/json.js': function (exports, module) {
    (module.exports = json),
...
const require_graphql = __commonJS({
  '../../node_modules/refractor/lang/graphql.js': function (exports, module) {
    ...
    function graphql(Prism) {
      (Prism.languages.graphql = {
        ...
        Prism.hooks.add('after-tokenize', (env) => {
          ...
          const validTokens = env.tokens.filter(
            (token) =>
              typeof token !== 'string' &&
              token.type !== 'comment' &&
              token.type !== 'scalar'
          ...
          function isTokenType(types, offset) {
            ...
            for (let i2 = 0; i2 < types.length; i2++) {
              const token = getToken(i2 + offset);
          ...
          function findClosingBracket(open, close) {
            for (
              let stackHeight = 1, i2 = currentIndex;
              i2 < validTokens.length;
              i2++
            ) {
              const token = validTokens[i2];
              const { content } = token;
...
const import_jsx = __toESM2(require_jsx());
const jsx_default = import_jsx.default;
const import_bash = __toESM2(require_bash());
const bash_default = import_bash.default;
const import_css = __toESM2(require_css());
const css_default = import_css.default;
const import_js_extras = __toESM2(require_js_extras());
const js_extras_default = import_js_extras.default;
const import_json = __toESM2(require_json());
const json_default = import_json.default;
const import_graphql = __toESM2(require_graphql());
const graphql_default = import_graphql.default;
const import_markup = __toESM2(require_markup());
const markup_default = import_markup.default;
const import_markdown = __toESM2(require_markdown());
const markdown_default = import_markdown.default;
const import_yaml = __toESM2(require_yaml());
const yaml_default = import_yaml.default;
const import_tsx = __toESM2(require_tsx());
const tsx_default = import_tsx.default;
const import_typescript = __toESM2(require_typescript());
const typescript_default = import_typescript.default;
...
function createStyleObject(classNames) {
  ...
  return classNamesCombinations.reduce(
    (styleObject, className) =>
      _objectSpread(_objectSpread({}, styleObject), stylesheet[className]),
    elementStyle
  );
}
...
const checkForListedLanguage_default = function (astGenerator, language) {
...
function _objectSpread2(target) {
  for (let i = 1; i < arguments.length; i++) {
    var source = arguments[i] != null ? arguments[i] : {};
    i % 2
      ? ownKeys2(Object(source), !0).forEach((key) => {
          _defineProperty(target, key, source[key]);
        })
      : Object.getOwnPropertyDescriptors
      ? Object.defineProperties(
      ...
      : ownKeys2(Object(source)).forEach((key) => {
          Object.defineProperty(
            target,
            key,
            Object.getOwnPropertyDescriptor(source, key)
...
function AllLineNumbers(_ref2) {
  ...
  const numberStyle = _ref2$numberStyle === void 0 ? {} : _ref2$numberStyle;
...
function assembleLineNumberStyles(
  ...
  const customLineNumberStyle =
    typeof lineNumberStyle === 'function'
      ...
      : lineNumberStyle;
  const assembledStyle = _objectSpread2(
...
function createLineElement(_ref3) {
  ...
  const lineProps = _ref3$lineProps === void 0 ? {} : _ref3$lineProps;
  const _ref3$className = _ref3.className;
  const className = _ref3$className === void 0 ? [] : _ref3$className;
  const { showLineNumbers } = _ref3;
  const { wrapLongLines } = _ref3;
  const properties =
...
`
          ...
          if (i === 0) {
            ...
            const _line = createLine(_children, lineNumber2);
            newTree.push(_line);
            ...
            if (stringChild) {
              ...
              const _children2 = [lastLineInPreviousSpan];
...
function getCodeTree(_ref6) {
  ...
  if (isHighlightJs(astGenerator)) {
    const hasLanguage = checkForListedLanguage_default(astGenerator, language);
...
function highlight_default(defaultAstGenerator, defaultStyle) {
  return function (_ref7) {
    ...
    const style = _ref7$style === void 0 ? defaultStyle : _ref7$style;
    const _ref7$customStyle = _ref7.customStyle;
    const customStyle = _ref7$customStyle === void 0 ? {} : _ref7$customStyle;
    ...
    let { wrapLines } = _ref7;
    const _ref7$wrapLongLines = _ref7.wrapLongLines;
    const wrapLongLines =
      _ref7$wrapLongLines === void 0 ? !1 : _ref7$wrapLongLines;
    const _ref7$lineProps = _ref7.lineProps;
    const lineProps = _ref7$lineProps === void 0 ? {} : _ref7$lineProps;
    let { renderer } = _ref7;
    const _ref7$PreTag = _ref7.PreTag;
    const PreTag = _ref7$PreTag === void 0 ? 'pre' : _ref7$PreTag;
    const _ref7$CodeTag = _ref7.CodeTag;
    const CodeTag = _ref7$CodeTag === void 0 ? 'code' : _ref7$CodeTag;
    ...
    const rest = _objectWithoutProperties(_ref7, _excluded);
...
const import_core = __toESM2(require_core());
const SyntaxHighlighter = highlight_default(import_core.default, {});
...
const prism_light_default = SyntaxHighlighter;
const Container = newStyled.div(({ theme }) => ({
  position: 'absolute',
  bottom: 0,
  right: 0,
  maxWidth: '100%',
...
const ActionButton = newStyled.button(
  ({ theme }) => ({
    margin: 0,
    border: '0 none',
    padding: '4px 10px',
...
const ActionBar = ({ actionItems, ...props }) =>
  import_react.default.createElement(
    Container,
    { ...props },
...
const GlobalScrollAreaStyles = (0, import_react.lazy)(() =>
  import('./GlobalScrollAreaStyles-UY5SB7EJ-BKTFUTA6.js')
);
const OverlayScrollbars = (0, import_react.lazy)(() =>
  import('./OverlayScrollbars-GZGLA7DL-YJ2Z3IBE.js')
);
const Scroller = ({ horizontal, vertical, ...props }) =>
  import_react.default.createElement(
...
const ScrollArea = newStyled(Scroller)(
  ({ vertical }) =>
    vertical ? { overflowY: 'auto', height: '100%' } : { overflowY: 'hidden' },
  ({ horizontal }) =>
    horizontal ? { overflowX: 'auto', width: '100%' } : { overflowX: 'hidden' }
);
ScrollArea.defaultProps = { horizontal: !1, vertical: !1 };
const { navigator, document: document2, window: globalWindow } = scope;
...
const themedSyntax = (0, import_memoizerific.default)(2)((theme) =>
...
const UnstyledScroller = ({ children, className }) =>
  import_react.default.createElement(
    ScrollArea,
    { horizontal: !0, vertical: !0, className },
    children
  );
const Scroller2 = newStyled(UnstyledScroller)(
  { position: 'relative' },
  ({ theme }) => themedSyntax(theme)
);
const Pre = newStyled.pre(({ theme, padded }) => ({
  display: 'flex',
  justifyContent: 'flex-start',
  margin: 0,
  padding: padded ? theme.layoutMargin : 0,
}));
const Code = newStyled.div(({ theme }) => ({
  flex: 1,
  paddingLeft: 2,
  paddingRight: theme.layoutMargin,
  opacity: 1,
}));
const processLineNumber = (row) => {
...
const defaultRenderer2 = ({ rows, stylesheet, useInlineStyles }) =>
  rows.map((node, i) =>
    createElement({
...
const wrapRenderer = (renderer, showLineNumbers) =>
  showLineNumbers
    ? renderer
      ? ({ rows, ...rest }) =>
...
const SyntaxHighlighter2 = ({
  ...
  const highlightableCode = formatter
    ? formatter(format, children)
    : children.trim();
  const [copied, setCopied] = (0, import_react.useState)(!1);
...
const syntaxhighlighter_default = SyntaxHighlighter2;
export {
  ActionBar,
  ScrollArea,
